                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" >
                                                 <a href="<?= current_url()."/edit/$row->CustomerId" ?>" class="btn btn-warning fa fa-edit " > Edit </a>
                                                <a href="<?= current_url()."/delete/$row->CustomerId" ?>" class="btn btn-danger fa fa-times delete-btn " > Delete </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
