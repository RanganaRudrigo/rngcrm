                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <fieldset class="form-group job-order-1">
                                            ...
                                            <div class="input-group   ">
                                                <input type="text"  data-date-format="yyyy-mm-dd"  name="replace[CurrentItemSerialDate]" class="form-control datepicker" value="<?= set_value("replace[CurrentItemSerialDate]",date('Y-m-d')) ?>" >
                                ...
                                <div class="row" >
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <fieldset class="form-group job-order-1">
                                            ...
                                            <div class="input-group   ">
                                                <input type="text"  data-date-format="yyyy-mm-dd"  class="form-control datepicker" name="replace[ReplaceItemSerialDate]"  value="<?= set_value("replace[ReplaceItemSerialDate]",date('Y-m-d')) ?>"  >
                                                <span class="input-group-addon"> <span class="zmdi zmdi-calendar"></span> </span>
                                            </div>
                                        </fieldset>
                                    </div>
