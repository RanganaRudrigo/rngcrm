                                ...
                                <div class="col-lg-12 col-sm-12 col-xs-12 col-md-12 col-xl-12">
                                    <table class="table table-bordered" >
                                        ...
                                        <tr>
                                            ...
                                            <td><?= "$supplier->title$supplier->contact_person" ?> </td>
                                        </tr> 
                                        <tr>
                                            <th> Contact </th>
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <table class="table table-bordered">
                                            ...
                                            <?php foreach ($PurchaseDetails as $k => $detail ): ?>
                                                <tr>
                                                    <td> <?= $k+1 ?> </td>
                                                    <td> <?= $detail->ItemCode ?> </td>
                                                    <td> <?= $detail->ItemName ?> </td>
                                                    <td> <?= $detail->Qty ?> </td>
                                                    <td> <?php foreach ($detail->serialList as $k =>$list) echo ($k==0 ? "":",").$list->SerialNo     ?> </td>
                                                </tr>
                                            <?php endforeach; ?>
                                            <tbody >
                                            </tbody>
