                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            ...
                                            <td class="text-center" >
                                                 <a href="<?= current_url()."/edit/$row->SupplierId" ?>" class="btn btn-warning fa fa-edit " > Edit </a>
                                                <a href="<?= current_url()."/delete/$row->SupplierId" ?>" class="btn btn-danger fa fa-times delete-btn " > Delete </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                    </tbody>
