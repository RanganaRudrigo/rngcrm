                                ...
                                <table  id="datatable-buttons" class=" table table-striped " >
                                    ...
                                    <?php foreach ($records as $k => $row): ?>
                                        <tr>
                                            ...
                                            <td>  <table class="table" ><?php foreach ($row->Items as $item) {
                                                    ?>
                                                        <tr> <td> <?= $item->Item->ItemCode." > ".$item->Item->ItemName ?> </td> </tr>
                                                    <?php
                                                }?></table>
                                            </td>
                                            <td>
                                                <table class="table" ><?php foreach ($row->Items as $item) {
                                                        ?>
                                                        <tr> <td> <?= $item->Qty ?> </td> </tr>
                                                        <?php
                                                    }?></table>
                                            </td>
                                        </tr>
