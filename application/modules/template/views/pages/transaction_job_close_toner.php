                ...
                <div class="col-sm-12">
                    ...
                    <div class="card-box" >
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <fieldset class="form-group">
                                    ...
                                    <select class="form-control " name="form[repair_mode]" id="repair_mode">
                                        ...
                                        <option>Replace - 01 </option>
                                        <option>Replace - 02 </option>
                                    </select>
                                </fieldset>
                            </div>
                        ...
                        <div class="row" >
                            ...
                            <fieldset class="form-group">
                                    <label for="repair_mode"> Note </label>
                                    <textarea class="form-control" id="exampleTextarea" rows="3" name="form[note]" id="note"
                             value="<?= $result->note ?>"
                       <?= form_error('form[note]') ?> placeholder="Note"></textarea>
                                </fieldset>
                                </fieldset>
